...
public class ViewModuleManager extends ModuleManager {
    ...
    public void initModules(Bundle saveInstanceState, Activity activity, View rootView, ArrayMap<String, ArrayList<Integer>> modules) {
        if (activity == null || modules == null) return;
        moduleConfig(modules);
        initModules(saveInstanceState, rootView, activity);
    }
